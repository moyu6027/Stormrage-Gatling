 ...
 * Use with grafana version 7.2.1
 */
...
// return function(callback) {
    ...
    // Set a title
    dashboard.title = 'Stormrage-Gatling Comparison Report';
    ...
    dashboard.templating = {
        list: [{
            ...
            },
            {
                ...
                "name": "scenario",
                "options": [],
                "query": "SHOW TAG VALUES FROM gatlingdb WITH key = \"application\"",
                "refresh": 1,
                "regex": "/(.*?) @/",
                "sort": 3,
                "tagValuesQuery": "",
            ...
            },
            {
                ...
                "name": "tag_left",
                "options": [],
                "query": "SHOW TAG VALUES FROM gatlingdb WITH key = \"application\" WHERE application =~ /^$scenario @/",
                "refresh": 1,
                "regex": "",
                "sort": 3,
                "tagValuesQuery": "",
            ...
            },
            {
                ...
                "options": [],
                "query": "SELECT * FROM gatlingdb WHERE application =~ /$tag_left/ ORDER BY time asc LIMIT 1",
                "refresh": 1,
                "regex": "",
                "sort": 0,
                "tagValuesQuery": "",
            ...
            },
            {
                ...
                "name": "end_time_left",
                "options": [],
                "query": "SELECT * FROM gatlingdb WHERE application =~ /$tag_left/ ORDER BY time desc LIMIT 1",
                "refresh": 1,
                "regex": "",
                "sort": 0,
                "tagValuesQuery": "",
            ...
            },
            {
                ...
                "options": [],
                "query": "SELECT * FROM gatlingdb WHERE application =~ /$tag_right/ ORDER BY time asc LIMIT 1",
                "refresh": 1,
                "regex": "",
                "sort": 0,
                "tagValuesQuery": "",
            ...
            },
            {
                ...
                "name": "end_time_right",
                "options": [],
                "query": "SELECT * FROM gatlingdb WHERE application =~ /$tag_right/ ORDER BY time desc LIMIT 1",
                "refresh": 1,
                "regex": "",
                "sort": 0,
                "tagValuesQuery": "",
    ...
    if (!_.isUndefined(ARGS["var-tag_left"])) {
        ...
        $.ajax({
            ...
            .done(function (result) {
                ...
                var shift = function () {
                    return start_time_right - start_time_left
                }
                    ...
                    "panels": [
                        ...
                        // Number of users
                        {
                            ...
                            "targets": [{
                                ...
                                "orderByTime": "ASC",
                                "policy": "default",
                                "query": "select difference(*) from(SELECT last(\"startedT\") FROM \"gatlingdb\" WHERE \"transaction\"='internal' AND \"application\" =~ /($tag_left|$tag_right)/ GROUP BY application)",
                                "rawQuery": true,
                                "refId": "A",
                                "resultFormat": "time_series",
                                "select": [
                        ...
                        // Average throughput diff
                        {
                            ...
                            "targets": [{
                                ...
                                "orderByTime": "ASC",
                                "policy": "default",
                                "query": "SELECT mean(last) FROM (SELECT  last(\"count\")/5 FROM \"gatlingdb\" WHERE \"transaction\" = 'all' AND time >= [[start_time_right]]000000 and time <= [[end_time_right]]000000 AND \"application\" =~ /$tag_right/ GROUP BY time(5s), application fill(null)) GROUP BY application",
                                "rawQuery": true,
                                "refId": "A",
                                "resultFormat": "time_series",
                                "select": [
                            ...
                            },
                                {
                                    ...
                                    "orderByTime": "ASC",
                                    "policy": "default",
                                    "query": "SELECT mean(last) FROM (SELECT  last(\"count\")/5 FROM \"gatlingdb\" WHERE \"transaction\" = 'all' AND time >= [[start_time_left]]000000 and time <= [[end_time_left]]000000 AND \"application\" =~ /$tag_left/ GROUP BY time(5s), application fill(null)) GROUP BY application",
                                    "rawQuery": true,
                                    "refId": "B",
                                    "resultFormat": "time_series",
                                    "select": [
                        ...
                        {
                            "aliasColors": {
                                "gatlingdb.activeThreads": "#e5ac0e",
                                "gatlingdb.countError": "#BF1B00",
                                "gatlingdb.minAT": "#EAB839"
                            },
                            "bars": false,
                            "dashLength": 10,
                            "dashes": false,
                ...
                for (var [key, value] of mertic_types) {
                    ...
                    var template_diff_non_aggregate_function = {
                        ...
                        "targets": [{
                            ...
                            "orderByTime": "ASC",
                            "policy": "default",
                            "query": "select difference(*) from(SELECT " + key + " FROM \"gatlingdb\" WHERE \"transaction\"='all' AND \"statut\"='all' AND \"application\" =~ /($tag_left|$tag_right)/ GROUP BY application)",
                            "rawQuery": true,
                            "refId": "A",
                            "resultFormat": "time_series",
                            "select": [
                    ...
                    "panels": [
                        ...
                        // Max throughput diff
                        {
                            ...
                            "targets": [{
                                ...
                                "orderByTime": "ASC",
                                "policy": "default",
                                "query": "select difference(*) from(SELECT max(last) FROM (SELECT  last(\"count\")/5 FROM \"gatlingdb\" WHERE \"transaction\" = 'all' AND \"application\" =~ /$tag_left|$tag_right/ GROUP BY time(5s), application fill(null)) GROUP BY application)",
                                "rawQuery": true,
                                "refId": "A",
                                "resultFormat": "time_series",
                                "select": [
        ...
        var message = "<h3>Select test runs to InfluxDB </h3> <button onclick=\"window.location.reload()\" type=\"button\" style=\"border: solid; display:inline; background-color: inherit;padding: 0px 20px;font-size: 16px;cursor: pointer;display: inline-block;color: green;\">Apply changes</button></h4>";
        $.ajax({
            method: 'GET',
            url: '/'
        })
